...
export default function Stats() {
  ...
  return (
    <section id="estadisticas" className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex-1 mx-4 bg-gray-200 rounded-full h-3">
                  <div className="bg-pachuca-blue h-3 rounded-full" style={{ width: '85%' }}></div>
                </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex-1 mx-4 bg-gray-200 rounded-full h-3">
                  <div className="bg-sport-green h-3 rounded-full" style={{ width: '92%' }}></div>
                </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex-1 mx-4 bg-gray-200 rounded-full h-3">
                  <div className="bg-pachuca-gold h-3 rounded-full" style={{ width: '78%' }}></div>
                </div>
          ...
          <div className="bg-gradient-to-br from-pachuca-blue to-blue-600 rounded-2xl p-8 text-white">
            ...
            <div className="mt-8 pt-6 border-t border-blue-400">
              <h4 className="font-semibold mb-4">Temporada 2024</h4>
              <div className="grid grid-cols-2 gap-4 text-center">
                <div>
                  <div className="text-2xl font-bold text-pachuca-gold">15</div>
